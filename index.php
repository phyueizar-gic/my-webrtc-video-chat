...
$pageTitle = 'Welcome to WebRTC Home Page';
require "shared/header.php";
?>
<div class = "u-p-id" data-userid = "<?php echo $userData->userID; ?>" data-profileid = ""></div>
	...
	<main class = "main-content">
		<div class="webcam-container">
			<div class = "webcam-img">
				<img src = "<?php echo url_for('assets/images/web_cam_w.png') ?>" alt = "Web Cam Image">
			</div>
			<div class="sub-title-web">Keep your webcam connected</div>
			<div class="sub-para">This app allow users to video chat with other users.</div>
		</div>
	</main>
</section>
...
<script>
    var conn = new WebSocket('wss://my-webrtc-video-chat.herokuapp.com:8080/?token=<?php echo $userData->sessionID; ?>');
